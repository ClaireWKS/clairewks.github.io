...
export class ProfileService {
  ...
  projects:any = [
    {
      id: 1,
      title: 'eCommerce Store web application',
      desc: '',
      livedemo: 'https://kobobakery.com',
      githurl: 'https://kobobakery.com',
      mediumlink: 'https://itnext.io/read-data-from-google-spreadsheet-in-angular-209ee74b6cb4',
      imgUrl: 'assets/images/z1.png',
      tech: 'Angular 10 , MySQL'
    },

    {
      id: 2,
      title: 'eCommerce Store Mobile application',
      desc: '',
      livedemo: 'https://play.google.com/store/apps/details?id=com.kobo.bakery',
      githurl: 'https://play.google.com/store/apps/details?id=com.kobo.bakery',
      mediumlink: 'https://play.google.com/store/apps/details?id=com.kobo.bakery',
      imgUrl: 'assets/images/z26.png',
      tech: 'Ionic framework with typescript'
    },
